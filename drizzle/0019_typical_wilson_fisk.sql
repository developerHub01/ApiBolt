...
INSERT INTO `__new_setting_table`("id", "backgroundImages", "backgroundOpacity", "backgroundBlur", "maxNumberOfImages", "slideInterval", "zoomLevel", "isZoomable", "codeFontSize", "indentationSize", "layoutType", "projectId") SELECT "id", "backgroundImages", "backgroundOpacity", "backgroundBlur", "maxNumberOfImages", "slideInterval", "zoomLevel", "isZoomable", "codeFontSize", "indentationSize", "layoutType", "projectId" FROM `setting_table`;--> statement-breakpoint
