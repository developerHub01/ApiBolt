...
export const loadAppBasicInfo = createAsyncThunk<
  void,
  void,
  {
...
>("app-info/loadAppBasicInfo", async (_, { dispatch }) => {
  try {
    const response = await window.electronAPIAppInfo.getAppBasicInfo();
