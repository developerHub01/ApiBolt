...
import ThreeContentEmptyBox from "@/components/ui/tree-view/ThreeContentEmptyBox";
...
type TreeViewType = typeof TreeViewBase & {
  ...
  EmptyBox: typeof ThreeContentEmptyBox;
...
TreeView.EmptyBox = ThreeContentEmptyBox;
