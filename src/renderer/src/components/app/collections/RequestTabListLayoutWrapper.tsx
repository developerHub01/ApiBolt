...
import { useRequestTabSidebar } from "@/context/tab-sidebar/RequestTabSidebarProvider";

interface Props {
  children: React.ReactNode;
}

const RequestTabListLayoutWrapper = memo(({ children }: Props) => {
...
export default RequestTabListLayoutWrapper;
