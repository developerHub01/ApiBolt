...
import BeautifyCode from "@/app/(app)/(request-panel)/request/[requestId]/_components/metadata/Body/BeautifyCode";
import BodyDetails from "@/app/(app)/(request-panel)/request/[requestId]/_components/metadata/Body/BodyDetails";
